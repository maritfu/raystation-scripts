      ...
      if indication in ['other','glottis']:
        ...
        if indication == 'other':
          ...
          if number_ln == 'one':
            ...
            ptv_n_68 = ROI.ROIAlgebra(ROIS.ptv_n_68.name, ROIS.ptv_n_68.type, ROIS.ptv_n_68.color, sourcesA = [ctv_n1_68], sourcesB = [ctv_n2_68], marginsA = MARGINS.uniform_4mm_expansion, marginsB = MARGINS.uniform_4mm_expansion)
            ...
            if number_ln == 'three':
              ...
              ptv_n_60.sourcesB.extend([ctv_n3_60])
              ptv_n_68.sourcesB.extend([ctv_n3_68])
          ...
          if number_ln == 'one':
            ...
            if number_ln == 'three':
              ...
              ctv_n3_60 =  ROI.ROIAlgebra(ROIS.ctv_n3_60.name, ROIS.ctv_n3_60.type, ROIS.ctv_n3_60.color, sourcesA=[ROIS.gtv_n3], sourcesB = [ROIS.body], operator = 'Intersection', marginsA = MARGINS.uniform_10mm_expansion, marginsB = MARGINS.zero)
              ptv_n_60.sourcesB.extend([ctv_n3_60])
              ptv_n_70.sourcesB.extend([ctv_n3_70])
