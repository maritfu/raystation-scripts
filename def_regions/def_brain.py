  ...
  def __init__(self, pm, examination, ss, choices, site):
    ...
    # Stereotactic brain:
      ...
      if nr_targets == 'one':
        ...
        x_ptv_ring_05 = ROI.ROIAlgebra(ROIS.x_ptv_ring_05.name, ROIS.x_ptv_ring_05.type, ROIS.x_ptv_ring_05.color, sourcesA=[ptv], sourcesB=[ptv], operator = 'Subtraction',marginsA = MARGINS.uniform_5mm_expansion, marginsB = MARGINS.zero)
        x_ptv_ring_2 = ROI.ROIAlgebra(ROIS.x_ptv_ring_2.name, ROIS.x_ptv_ring_2.type, ROIS.x_ptv_ring_2.color, sourcesA=[ptv], sourcesB=[ptv], operator = 'Subtraction',marginsA = MARGINS.uniform_20mm_expansion, marginsB = MARGINS.uniform_5mm_expansion)
        #wall_ptv = ROI.ROIWall(ROIS.z_ptv_wall.name, ROIS.z_ptv_wall.type, COLORS.wall, ptv, 1, 0)
        #site.add_targets([wall_ptv])
        site.add_targets([x_ptv_ring_05,x_ptv_ring_2])
      # Multiple targets (2, 3 or 4):
        ...
        x_ptv1_ring_05 = ROI.ROIAlgebra(ROIS.x_ptv1_ring_05.name, ROIS.x_ptv1_ring_05.type, ROIS.x_ptv1_ring_05.color, sourcesA=[ptv1], sourcesB=[ptv1], operator = 'Subtraction',marginsA = MARGINS.uniform_5mm_expansion, marginsB = MARGINS.zero)
        x_ptv1_ring_2 = ROI.ROIAlgebra(ROIS.x_ptv1_ring_2.name, ROIS.x_ptv1_ring_2.type, ROIS.x_ptv1_ring_2.color, sourcesA=[ptv1], sourcesB=[ptv1], operator = 'Subtraction',marginsA = MARGINS.uniform_20mm_expansion, marginsB = MARGINS.uniform_5mm_expansion)
        x_ptv2_ring_05 = ROI.ROIAlgebra(ROIS.x_ptv2_ring_05.name, ROIS.x_ptv2_ring_05.type, ROIS.x_ptv2_ring_05.color, sourcesA=[ptv2], sourcesB=[ptv2], operator = 'Subtraction',marginsA = MARGINS.uniform_5mm_expansion, marginsB = MARGINS.zero)
        x_ptv2_ring_2 = ROI.ROIAlgebra(ROIS.x_ptv2_ring_2.name, ROIS.x_ptv2_ring_2.type, ROIS.x_ptv2_ring_2.color, sourcesA=[ptv2], sourcesB=[ptv2], operator = 'Subtraction',marginsA = MARGINS.uniform_20mm_expansion, marginsB = MARGINS.uniform_5mm_expansion)
        site.add_targets([x_ptv1_ring_05,x_ptv1_ring_2,x_ptv2_ring_05,x_ptv2_ring_2])
        ...
        if nr_targets in ['three','four']:
          ...
          x_ptv3_ring_05 = ROI.ROIAlgebra(ROIS.x_ptv3_ring_05.name, ROIS.x_ptv3_ring_05.type, ROIS.x_ptv3_ring_05.color, sourcesA=[ptv3], sourcesB=[ptv3], operator = 'Subtraction',marginsA = MARGINS.uniform_5mm_expansion, marginsB = MARGINS.zero)
          x_ptv3_ring_2 = ROI.ROIAlgebra(ROIS.x_ptv3_ring_2.name, ROIS.x_ptv3_ring_2.type, ROIS.x_ptv3_ring_2.color, sourcesA=[ptv3], sourcesB=[ptv3], operator = 'Subtraction',marginsA = MARGINS.uniform_20mm_expansion, marginsB = MARGINS.uniform_5mm_expansion)
          ...
          site.add_targets([x_ptv3_ring_05,x_ptv3_ring_2])
          ...
          if nr_targets in ['four']:
            ...
            x_ptv4_ring_05 = ROI.ROIAlgebra(ROIS.x_ptv4_ring_05.name, ROIS.x_ptv4_ring_05.type, ROIS.x_ptv4_ring_05.color, sourcesA=[ptv4], sourcesB=[ptv4], operator = 'Subtraction',marginsA = MARGINS.uniform_5mm_expansion, marginsB = MARGINS.zero)
            x_ptv4_ring_2 = ROI.ROIAlgebra(ROIS.x_ptv4_ring_2.name, ROIS.x_ptv4_ring_2.type, ROIS.x_ptv4_ring_2.color, sourcesA=[ptv4], sourcesB=[ptv4], operator = 'Subtraction',marginsA = MARGINS.uniform_20mm_expansion, marginsB = MARGINS.uniform_5mm_expansion)
            ...
            site.add_targets([x_ptv4_ring_05,x_ptv4_ring_2])
